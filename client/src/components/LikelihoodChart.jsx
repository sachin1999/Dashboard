...
import { fetchedLikelihood } from '../state/api';

const LikelihoodChart = ({ isDashboard = false }) => {
    const theme = useTheme();
    const formattedData = fetchedLikelihood.map(({Likelihood, Count}) => 
    ({Likelihood: parseInt(Likelihood), Count: Count}));
