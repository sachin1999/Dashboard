...
import {fetchedPestle} from "../state/api"

const PestleChart = ({ isDashboard = false }) => {
    const theme = useTheme();
    const formattedData = Object.entries(fetchedPestle).map(
        ([id, value], i) => ({
        ...
        legends={[
          {
              ...
              direction: 'column',
              justify: false,
              translateX: isDashboard ? 320: 400,
              translateY: isDashboard ? 30: -100,
              itemsSpacing: 0,
              itemWidth: 10,
              itemHeight: 22,
